...
import { getExperienceInfo, getTechnicalSkillsInfo, getSoftSkillsInfo } from "@/lib/data"
...
export default function Home() {
  ...
  const softSkills = getSoftSkillsInfo()
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="relative z-10 container mx-auto p-3 sm:p-4 pt-20 sm:pt-24 pb-6 sm:pb-8">
        ...
        >
          <p>© {new Date().getFullYear()} Oladiran Ayanfe. All rights reserved.</p>
        </AnimatedSection>
      </div>
