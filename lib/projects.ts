...
const projects: Project[] = [
  ...
  {
    id: 13,
    slug: "indie-developer-group",
    title: "Indie Developer Group",
    category: "Web Application / Backend Engineering",
    shortDescription:
      "A collaborative platform for indie developers featuring robust API infrastructure, database models, and server logic.",
    description: [
      "Indie Developer Group is a dynamic web platform built to connect and empower indie software developers worldwide. The platform offers resources, community collaboration, and project showcases.",
      "Collaborated with a backend teammate to design & engineer API infrastructure, database models, and server logic ensuring scalable and reliable data processing.",
      "Designed high-performance RESTful APIs, optimized database queries with MongoDB, and built server architecture using Next.js, Node.js, and Express.js.",
    ],
    features: [
      "Robust API infrastructure and server-side business logic",
      "Scalable database schemas and data models using MongoDB",
      "User management and authentication workflows",
      "Developer community showcase and resource hub",
      "High-performance RESTful API endpoints",
    ],
    technologies: ["Next.js", "Node.js", "MongoDB", "Express.js", "RESTful APIs", "TypeScript"],
    coverImage: "/indie-dev-group.png",
    thumbnailImage: "/indie-dev-group.png",
    gallery: [{ url: "/indie-dev-group.png", caption: "Platform Preview" }],
    timeline: "Q1 2026",
    role: "Backend Developer (Collaborated with a backend teammate to design & engineer API infrastructure, database models, and server logic)",
    liveUrl: "https://www.indiedevelopergroup.com/",
    githubUrl: "https://github.com/IndieDeveloperGroup-org/idgrwebsite",
    client: "Indie Developer Group",
  },
  {
    id: 14,
    slug: "buzzap-hq",
    ...
    shortDescription:
      "A modern digital agency platform designed for business growth, marketing automation, and seamless service delivery.",
    description: [
      "Buzzap HQ is a modern digital agency web platform engineered to deliver end-to-end digital solutions, marketing automation, and client services.",
      "As the Full Stack Developer, built a high-performance web application combining Next.js frontend with Node.js and MongoDB backend server architecture.",
      "Implemented sleek, responsive user interfaces with Tailwind CSS and integrated seamless RESTful API services for smooth client onboarding and service request handling.",
    ],
    features: [
      "Full-stack digital agency web platform with sleek UI/UX",
      "Responsive and modern interface powered by Tailwind CSS and Next.js",
      "RESTful API integration for lead generation and client interaction",
      "Backend data management and customer portal using MongoDB & Node.js",
      "Optimized for fast performance, SEO, and user conversion",
    ],
    technologies: ["Next.js", "Node.js", "MongoDB", "Tailwind CSS", "RESTful APIs", "TypeScript"],
    coverImage: "/buzzap-hq.png",
    thumbnailImage: "/buzzap-hq.png",
    gallery: [{ url: "/buzzap-hq.png", caption: "Agency Platform Overview" }],
    timeline: "Q1 2026",
    role: "Full Stack Developer",
    liveUrl: "https://www.buzzaphq.com/",
    githubUrl: "https://github.com/marvecodeit/Buzzap-Website-Frontend",
    client: "Buzzap Agency",
  },
]
